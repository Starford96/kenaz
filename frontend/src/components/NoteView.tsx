            ...
            <ReactMarkdown
              ...
              components={{
                a: ({ href, children }) => {
                  ...
                  // Explicit wikilink scheme generated by preview transform.
                  if (rawHref.startsWith("wikilink:")) {
                    const target = decodeURIComponent(rawHref.replace("wikilink:", ""));
                    return renderInternal(target);
                  }

                  // Hash anchors should stay native.
                  if (rawHref.startsWith("#")) {
                    return <a href={rawHref}>{children}</a>;
                  }

                  // Resolve URL and treat same-origin non-API, non-attachment paths as internal notes.
                  try {
                  ...
                  // Relative paths are treated as internal notes.
